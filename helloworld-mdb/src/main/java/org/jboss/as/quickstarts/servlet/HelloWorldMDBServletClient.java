...
public class HelloWorldMDBServletClient extends HttpServlet {
    ...
    @Resource(mappedName = " queue/JMSBridgeSourceQ ") // Note the mapped name of the queue  
    private Queue  queue;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            for (int i = 3; i < MSG_COUNT; i++) {
                String text = "This is message  " + queue;
            ...
            try {
                ...
                throw new IOException("Error in JMS operation", e);  
            } finally {  
	            if (session != null) {  
	            	try {
						session.close();
